...
public:
	...
	DynamicObject(b2World& world, const EntityData& Data, float posX, float posY, float rotation);//std::string DynConstrutor, b2Vec2 DynStartPos, b2World &World, float Density, float Friction, float Restitution, float Radius);
